...
public class Order_and_Chaos extends BoardGame{// Play the Order and Chaos
    private char choice;
    ...
    public void Start() throws Exception{// Start a Tic Tac Toe game
        ...
        now_board.Reset_Board_Size(6,6);

        Piece now_pieces = new Piece(6,6);
        ...
        do{
            ...
            do{
                round.Next_Round();
                do{
                    this.this_move = round.Next_Round_Move(now_board.board_length, now_board.board_length);
            ...
            if(if_continue){
                now_pieces.Reset_Pieces(now_board.board_length, now_board.board_length);
                round.ResetRound();
            }
        }while(if_continue);
