...
public class Round {//Create round
    ...
    public char Get_Next_Round_Choice() throws Exception {//Let the player give their choice of next step
        ...
        do{
            ...
            this.user_enter = sc.next();
            if (this.user_enter.length() != 1) {
                System.out.println("\nPlease only enter W/A/S/D to move, Q to quit the game, I to show information, M to enter market");
            }
            else{
                this.choice = user_enter.charAt(0);
                if (choice == 'W' || choice == 'A' || choice == 'S' || choice == 'D' || choice == 'Q' || choice == 'I' || choice == 'M' ||
                        choice == 'w' || choice == 'a' || choice == 's' || choice == 'd' || choice == 'q' || choice == 'i' || choice == 'm') {
