public class Board implements Print_Board{ //Create the board
    ...
    public void Print_SuperTicTacToe_Board(int main_board_length, int main_board_width, int sub_board_length, int sub_board_width, Piece[] sub_pieces) throws Exception{//Print the board of super-TTT game
    ...
    public void Print_Quoridor_Board(int[][] pieces, int[][][][] walls) throws Exception{//Print the board of Quoridor game
        for (column = 0; column < board_width-1; column++) {
            if(walls[0][column][0][column+1] == 0) {
                if (pieces[0][column] == 0) {
                    System.out.printf("\t|");
                } else if (pieces[0][column] == 1) {
                    System.out.printf("O");
        ...
        for (row = 1; row < board_length; row++){
            for (column = 0; column < board_width; column++) {
                if(walls[row][column][row-1][column] == 0){
                    System.out.printf("--------");
                }
                else{
                    System.out.printf("========");
            ...
            System.out.printf("\n");
            for (column = 0; column < board_width-1; column++) {
                if(walls[row][column][row][column+1] == 0) {
                    if (pieces[row][column] == 0) {
                        System.out.printf("\t|");
                    } else if (pieces[row][column] == 1) {
                        System.out.printf("O");
