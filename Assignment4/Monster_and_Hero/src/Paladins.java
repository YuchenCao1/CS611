...
public class Paladins extends Hero{//Create Paladins
    private String name;
    private int MP;
    ...
    public Paladins(String name, int MP, int strength, int agility, int dexterity, int gold, int experience_points, int number_of_available_hands){
        this.name = name;
        this.MP = MP;
