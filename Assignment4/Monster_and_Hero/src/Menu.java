...
public class Menu {  //Create menu
    private boolean exit_or_not_mainmenu = false;
    ...
    public void MainMenu() throws Exception { //Create the main menu
        ...
        do {
            System.out.println("\n===============Games===============");
            System.out.println("\t1. Start a new Monster and Hero game");
            System.out.println("\t2. Start a new Board game");
            ...
            if (user_enter.length() != 1) {
                ...
                switch (choice) {
                    case '1':
                        Game new_Monster_and_Hero_game = new Monster_and_Hero();
                        new_Monster_and_Hero_game.Start();
                        break;
                    case '2':
                        MainMenu_BoardGames();
                        break;
        ...
        } while (!exit_or_not_mainmenu);
    }
    public void MainMenu_BoardGames() throws Exception { //Create the main menu
    ...
    public boolean SubMenu2() throws Exception { //Create the main menu
        Get_user_Answer get_answer = new Get_user_Answer();

        System.out.println("Do you want to exit market?(y/n)");
        if_continue = get_answer.Get_y_or_n_Answer();
